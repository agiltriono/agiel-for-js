...
function ProtectedLink2() {
    var ProtectedLink2 = new Array();
    setting.exceptionurl = setting.exceptionurl;
    ProtectedLink2 = setting.exceptionurl.split(",");
    return ProtectedLink2;
}
...
var ProtectedLink2 = ProtectedLink2();

function GetJSONFeed(datajson) {

    var check = false;
    var no = 0;
    var exceptionlength = ProtectedLink2.length;
    var checklink = "";
    var checkexception = "";
    ...
    for (var i = 0; i < linktag.length; i++) {
        ...
        while (check == false && no < exceptionlength) {
            checklink = GetDomUri(linktag[i].href);
            checkexception = GetDomUri(ProtectedLink2[no]);
        ...
        if (check == false) {
            linktag[i].href = links[randindex] + setting.path + AdvanceEncyrptionJS.encrypt(ConvertToString(linktag[i].href), ConvertToString('root'));
